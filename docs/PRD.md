...
- pada tahap sensor, data identik tidak dikirim to server.
...
- deletion/modification of sensor integrations;
...
|---|---|---|
| 2.1 | 24 Agustus 2026 | Menggabungkan draf lama dan versi lengkap (v2.0) ke docs/PRD.md sebagai satu-satunya dokumen sumber kebenaran, memperbarui status, serta detail arsitektur HTTPS API dan target keamanan. Menghapus file PRD.md di root project. |
